...
```
cd existing_repo
git remote add origin https://gitlab.com/ghassen-oueslati/internship.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/ghassen-oueslati/internship/-/settings/integrations)
